...
{ 
  ...
  if (WRAPTEXT)
	  docW = docW + "</td>"+this.prependHTML+"<td valign=middle width=100% class=widFontNormal>"
  else
	  docW = docW + "</td>"+this.prependHTML+"<td valign=middle nowrap width=100% class=widFontNormal>"
  if (USETEXTLINKS) 
  { 
