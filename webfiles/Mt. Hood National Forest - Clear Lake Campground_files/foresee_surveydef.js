...
*/
  ...
  },
  {
    ...
    include: {
      urls: ['http://www.treesearch.fs.fed.us/', 'http://www.nrs.fs.fed.us/', 'http://www.srs.fs.usda.gov/index.php']
    }
  },
  {
    name: 'browse',
    ...
    include: {
      urls: ['http://www.fpl.fs.fed.us/', 'http://www.fs.fed.us/rmrs/', 'http://www.fs.fed.us/research/']
    }
  },
  {
    name: 'browse',
    ...
    include: {
      urls: ['http://www.fs.fed.us/pnw/', 'http://www.fs.fed.us/psw/', 'http://www.fia.fs.fed.us/']
    }
  },
  {
    name: 'browse',
    ...
    include: {
      urls: ['http://www.fs.usda.gov/iitf']
    }
  },
  {
    name: 'browse',
    ...
    include: {
      urls: ['/pnw', '/rmrs', '/psw', 'fpl.fs', 'nrs.fs', 'srs.fs', 'treesearch', '/global/iitf', '/research', '/archive', 'efrdata', '/efr/', '/ef/', 'fia.fs']
    }
  },
  {
    name: 'browse',
...
*/
  FSR.properties = {
    ...
    exclude: {
      variables: [{
        name: 'strIP',
        value: [/166.7.*.*/, /166.2.*.*/, /166.3.*.*/, /166.4.*.*/, /166.5.*.*/, /166.6.*.*/, /199.131.*.*/, /165.221.30.*/, /165.221.40.*/, /170.144.*.*/, /192.131.1.*/, /192.132.98.*/, /165.221.108.*/, /165.221.112.*/, /199.141.131.*/, /199.141.135.*/, /199.141.136.*/]
      }]
...
/*dialogs : [
    ...
    cpps: {
      subsiteCode: { //this will be the name of the cpp
        source: 'variable',
        name: 'subsiteCode' //the value sent will be the value of the parameter
      }
    },
